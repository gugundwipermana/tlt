...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="active"><a href="<?php echo base_url('admin_controller/image_award/'.$id_content) ?>"><i class="fa fa-dashboard"></i> Images</a></li>
...
<section class="content">
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			...
			<div>Image require < 800KB, 1280 X 800 Pixel</div>
		</div>
	...
	<div class="form-group">
        <div class="col-sm-2">
			<a href="<?php echo base_url('admin_controller/image_award/'.$id_content); ?>"><button class="btn btn-default" type="button">Cancel</button></a>
		</div>
        <div class="col-sm-10">
            <?php
