...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li class="active"><a href="<?php echo base_url('admin_controller/team/'.$pid); ?>"><i class="fa fa-dashboard"></i> Project Team</a></li>
    ...
    <div class="box">
        <div class="box box-default">
            ...
            <div class="box-body"> 
				<?php
				if (isset($team)){
					$content_description_1 = $team->content_description_1;
					$content_description_2 = $team->content_description_2;
					$content_description_1_id = $team->content_description_1_id;
					$content_description_2_id = $team->content_description_2_id;
				}else{
				...
				<div class="form-group">
					<div class="col-sm-2">
						<a href="<?php echo base_url('admin_controller/team/'.$pid); ?>"><button class="btn btn-default" type="button">Cancel</button></a>
					</div>
					<div class="col-sm-10">
						<?php
