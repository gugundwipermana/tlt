...
*/
   ...
   function initialize() {
        var cord = new google.maps.LatLng(-6.2306927,106.8172668);
      var mapProp = {
        center:cord,
        zoom:15,
	...
	var base_url = "assets/dist/img/marker.png";
      ...
      var contentString = '<h2 style=color:#ef434d>Telkom Landmark Tower</h2>';
...
<!-- 
<script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAUdea486kvkbjMWyebtH3XOLtDghFAqHs&signed_in=true&callback=initialize">
</script>
<script>
function initialize() {
 ...
 */
 ...
 $('.show-floor').click(function() {
    $('.image-floor').removeClass('hid');
    $('.floor-desc').addClass('hid');

    $('.show-des').removeClass('active');
    $('.show-floor').addClass('active');
 });

 $('.show-des').click(function() {
    $('.image-floor').addClass('hid');
    $('.floor-desc').removeClass('hid');

    $('.show-des').addClass('active');
    $('.show-floor').removeClass('active');
 });
 ...
 */
 ...
 $('.show-mess').click(function() {
    $('.message').removeClass('hid');
    $('.contact-det').addClass('hid');

    $('.show-mess').addClass('active');
    $('.show-con').removeClass('active');
 });

 $('.show-con').click(function() {
    $('.message').addClass('hid');
    $('.contact-det').removeClass('hid');

    $('.show-mess').removeClass('active');
