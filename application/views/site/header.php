<div class="logo white li-nav" style=""><a href="#1" data-index="1"><img src="<?php echo base_url('assets/dist/img/logo-white.png'); ?>" height="45"></a></div>
<div class="logo red li-nav" style=""><a href="#1" data-index="1"><img src="<?php echo base_url('assets/dist/img/logo.png'); ?>" height="45"></a></div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            foreach ($menu as $key => $mn) {
                $j++;
                ?>
                <li class="li-nav"><a href="#<?php echo $j; ?>" data-index="<?php echo $j; ?>"><?php echo $mn['menu_name']; ?></a></li>
                <?php
            }
            ?>
