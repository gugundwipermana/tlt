...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li class="active"><a href="<?php echo base_url('admin_controller/bod/'.$pid); ?>"><i class="fa fa-dashboard"></i> BOD</a></li>     
    </ol>
</section>
    ...
    <div class="box">
        <div class="box box-default">
            ...
            <div class="box-body"> 
				<?php
				if (isset($bod)){
					$content_description_1 = $bod->content_description_1;
					$content_description_2 = $bod->content_description_2;
					$content_description_1_id = $bod->content_description_1_id;
					$content_description_2_id = $bod->content_description_2_id;
					$img = $bod->images_name;
				}else{
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="content_description_1_id">Name</label>
					<div class="col-sm-10">			
						<?php						
				...
				<div class="form-group">
					<div class="col-sm-2">
						<a href="<?php echo base_url('admin_controller/bod/'.$pid); ?>"><button class="btn btn-default" type="button">Cancel</button></a>
					</div>
					<div class="col-sm-10">
						<?php
