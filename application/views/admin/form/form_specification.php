...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li class="active"><a href="<?php echo base_url('admin_controller/specification/'.$pid); ?>"><i class="fa fa-dashboard"></i> Specification</a></li>     
    </ol>
</section>
        ...
        <div class="box box-default">
            ...
            <div class="box-body"> 
				...
				if (isset($specification)){
					$content_description_1 = $specification->content_description_1;
					$content_description_2 = $specification->content_description_2;
					$content_description_1_id = $specification->content_description_1_id;
					$content_description_2_id = $specification->content_description_2_id;
				}else{
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="content_description_1_id">TDetail Indo</label>
					<div class="col-sm-10">			
						<?php						
				...
				<div class="form-group">
					<div class="col-sm-2">
						<a href="<?php echo base_url('admin_controller/specification/'.$pid); ?>"><button class="btn btn-default" type="button">Cancel</button></a>
					</div>
					<div class="col-sm-10">
						<?php
