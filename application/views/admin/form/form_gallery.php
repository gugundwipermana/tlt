...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li class="active"><a href="<?php echo base_url('admin_controller/gallery'); ?>"><i class="fa fa-dashboard"></i> Gallery</a></li>
    </ol>
</section>
    ...
    <div class="box">
        <div class="box box-default">
            ...
            <div class="box-body"> 
				<?php
				if (isset($gallery)){
					$content_description_1 = $gallery->content_description_1;
					$content_description_1_id = $gallery->content_description_1_id;					
					$img = $gallery->images_name;
				}else{
				...
				<div class="form-group">
					<div class="col-sm-2">
						<a href="<?php echo base_url('admin_controller/gallery'); ?>"><button class="btn btn-default" type="button">Cancel</button></a>
					</div>
					<div class="col-sm-10">
						<?php
