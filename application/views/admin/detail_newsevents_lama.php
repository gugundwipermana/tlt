            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                	...
                	if (count($detail_newsevents) == 0) {
                		?>
						<a href="<?php echo base_url('admin_controller/add_detail_newsevents/'.$pid); ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Add">
							...
							?>
								<tr>
									...
									<td rowspan="2">
										...
										<a href="<?php echo base_url('admin_controller/edit_detail_newsevents/'.$rw->id.'/'.$pid); ?>" class="btn btn-warning btn-xs" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>

										<a href="<?php echo base_url('admin_controller/delete_detail_newsevents/'.$rw->id) ?>" class="btn btn-danger btn-xs" data-toggle="tooltip" title="Delete" onclick="konfirmasihapus(event)"><i class="fa fa-trash"></i></a>
